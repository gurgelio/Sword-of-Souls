...
class Fontes {
    ...
    static TrueTypeFont Fonte2 = new TrueTypeFont(new Font("Verdana",Font.PLAIN,35), true);
    static org.newdawn.slick.Color Red = new org.newdawn.slick.Color(204,0,0,255);
