...
public class Hud {
    ...
    void renderInventory(){
        ...
        if (invState) {
            ...
            equip.draw(-x + Game.width - inventory.getWidth() - equip.getWidth(), -y + Game.height - inventory.getHeight() + 24);
            title.draw(-x + Game.width - inventory.getWidth() - equip.getWidth(), -y + Game.height - inventory.getHeight());
